...
const DCEOSection = () => {
  ...
  return (
    <section className="py-12 sm:py-20 bg-gradient-to-br from-primary/5 to-sustainability/5">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="text-center mb-12 sm:mb-16 animate-slide-up">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-6 text-foreground">
          ...
          {/* Initiative Origin */}
          <div className="text-center mb-12 sm:mb-16 animate-slide-up">
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-soft border border-primary/10">
              <h3 className="text-xl sm:text-xl md:text-2xl font-bold text-primary mb-3 sm:mb-4">
                From Vision to Action
              </h3>
              <p className="text-sm sm:text-base md:text-lg text-foreground leading-relaxed max-w-4xl mx-auto">
                The KOC PPE Recycling Campaign was born from Deputy CEO Ameena Rajab Saleh's commitment to environmental sustainability
          ...
          {/* DCEO Card */}
          <Card className="shadow-corporate hover:shadow-elevated transition-smooth animate-fade-in overflow-hidden mb-6 sm:mb-8">
              ...
              <div className="block md:hidden">
                ...
                <div className="p-4 bg-white">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-lg font-bold text-primary">DCEO Message</h4>
                    <button
                  ...
                  <div className={`${isDCEOMessageExpanded ? 'block' : 'hidden'}`}>
                    ...
                    <div className="bg-sustainability/10 border border-sustainability/20 p-3 rounded-lg mt-3">
            ...
            <CardContent className="p-0">
              ...
              <div className="block md:hidden">
                ...
                <div className="bg-gradient-corporate p-6 text-white text-center">
                  ...
                  />
                  <h3 className="text-lg font-bold mb-1">Naser Bader Al-Buhairi</h3>
                  <p className="text-white/90 text-sm">Manager Health, Safety & Environment</p>
                </div>

                {/* HSE Manager Message */}
                <div className="p-4 bg-white">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-lg font-bold text-primary">HSE Manager Message</h4>
                    <button
                  ...
                  <div className={`${isHSEMessageExpanded ? 'block' : 'hidden'}`}>
                    <blockquote className="text-foreground leading-relaxed text-sm italic border-l-4 border-primary pl-4 mb-4">
                    ...
                    {/* HSE coordination info for mobile */}
                    <div className="bg-sustainability/10 border border-sustainability/20 p-3 rounded-lg mt-3">
                      <p className="text-foreground leading-relaxed text-sm">
